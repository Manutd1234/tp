...
public class Person {
    ...
    public Person(Name name, Phone phone, Email email, Set<Tag> tags) {
        this(name, phone, email, new Remark(""), tags);
    }

    /**
     * Creates a person with an optional remark. Every argument must be non-null.
     */
    ...
    /**
     * Returns the optional note about this person.
     */
